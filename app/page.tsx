  ...
  return (
    <>
      <main className="flex min-h-screen flex-col">
        ...
        <h1 className={`text-7xl mx-auto mt-9 w-6/12 pt-8 pb-9 text-center ${playfair_display.className} bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500`}>The world’s destination for design</h1>
        <p className="text-center">Get inspired by the work of millions of top-rated <span className="select-text">designers</span> & agencies around the world.</p>
